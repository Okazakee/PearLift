...
export const E2E_IDS = {
  ...
  syncDebug: {
    ...
    statusValue: 'syncDebug.value.status',
    syncModeValue: 'syncDebug.value.syncMode',
    syncRoleValue: 'syncDebug.value.syncRole',
    deviceNameValue: 'syncDebug.value.deviceName',
    roomStateValue: 'syncDebug.value.roomState',
    firstSyncResolutionValue: 'syncDebug.value.firstSyncResolution',
    connectionsValue: 'syncDebug.value.connections',
    pairedDevicesCountValue: 'syncDebug.value.pairedDevicesCount',
    pairedDeviceNamesValue: 'syncDebug.value.pairedDeviceNames',
    pendingLocalSummaryValue: 'syncDebug.value.pendingLocalSummary',
    pendingRemoteSummaryValue: 'syncDebug.value.pendingRemoteSummary',
